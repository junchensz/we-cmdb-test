...
def writeSystemDesign(startIndex,count):
    sampleRow = ['0001_0000000001','\\N','0001_0000000001','umadmin','2019/9/9 2:12','umadmin','2019/9/4 21:21','DEMO','34','','DEMO','','\\N','','105','demo system']
    rows=[]
    i = startIndex
    while i < startIndex + count:
        sampleRow[0] = genGuid(systemDesign_prefix,i)
        sampleRow[2] = genGuid(systemDesign_prefix,i)
        sampleRow[6] = 'Demo'+str(i)
...
def writeSubSystemDesigin(systemDesign,startIndex,count):
    sampleRow = ['0002_0000000001','\\N','0002_0000000001','umadmin','2019/9/4 21:25','umadmin','2019/9/4 21:25','DEMO-SUBSYS1','34','','SUBSYS1','','\\N','','105','129','sub system','0001_0000000001']
    rows=[]
    i = startIndex
    while i < startIndex + count:
...
def writeSubSystem(subsysDesign,startIndex,count):
    sampleRow = ["0007_0000000001",'\\N',"0007_0000000001","umadmin","2019-07-24 08:30:17","umadmin","2019-07-24 06:40:03","ECIF-CORE_PRD","37","2019-07-24 16:30:17","CORE","ECIF-CORE PRD",'\\N','\\N',"111","test","0002_0000000010"]
    rows=[]
    i = startIndex
    while i < startIndex + count:
...
def writeUnit(subsys,startIndex,count):
    sampleRow = ["0008_0000000001",'\\N',"0008_0000000001","umadmin","2019-07-24 08:30:35","umadmin","2019-07-24 08:14:07","ECIF-CORE_PRD-APP","37","2019-07-24 16:30:35","APP","",'\\N','\\N',"1","","0007_0000000001","0003_0000000006"]
    rows=[]
    i = startIndex
    while i < startIndex + count:
...
def writeRunningInstance(host,unit,startIndex,count):
    sampleRow = ["0015_0000000008","0015_0000000021","0015_0000000008","umadmin","2019-09-18 17:59:00","umadmin","2019-09-09 03:17:02","GZ3-SYSTEM-GZ3-SUBSYSTEM_STGi-GZ3-TEST_TEST-02","43","2019-09-18 17:59:00","TEST-02","TEST-02",'\\N','\\N',"","115","0012_0000000054","50","4","3","24595","174","0008_0000000008","306",'\\N']
    rows=[]
    i = startIndex
    while i < startIndex + count:
...
def writeHost(ip,startIndex,count):
    guidIndex = '0012'
    sampleRow = ["0012_0000000031","0012_0000000043","0012_0000000031","umadmin","2019-08-30 00:35:49","umadmin","2019-08-26 03:13:45","TEST-250-02_10.250.1.2","44","","TEST-250-02","TEST-250-02","259","rAwq3wWh2Bl","ins-3yv1ur1i","115","167",'\\N','\\N',"0014_0000000079","TEST-250-02","164","0020_0000000017","162","","08069f86f35c68ba4491be5d90595d32",'\\N','\\N']
    rows=[]
    i = startIndex
    while i < startIndex + count:
...
def writeIpAndHost(networkSenment,startIndex,count):
    #guidIndex = '0014'
    sampleRow = ["0014_0000000001",'\\N',"0014_0000000001","umadmin","2019-09-08 15:40:02","umadmin","2019-07-24 11:40:31","10.0.16.1/24","37","","10.0.16.1","Demo DMZ proxy Gateway",'\\N','\\N',"0021_0000000006","172","0014_0000000001_ttt_10.0.16.1_0014_0000000001_10.0.16.0/24_VPC子网网段"]
    rows=[]
    i = startIndex
    while i < startIndex + count:
...
def writeNetworkSegment(startIndex,count):
    #guidIndex = '0021'
    sampleRow = ["0021_0000000001",'\\N',"0021_0000000001","admin","2019-09-09 07:52:55","umadmin","2019-07-24 11:25:55","10.0.0.0/16_idc segment","37","2019-09-09 15:52:55","10.0.0.0/16","demo",'\\N','\\N',"","","","16","demo","179"]
    rows=[]
    i = startIndex
    while i < startIndex + count:
...
#writeSystemDesign('0001',10)
#writeSubSystemDesigin('0001_0000000001',10)
#writeSubSystem('0002_0000000001',1,10)
#writeUnit('0007_0000000001',1,10)
#writeRunningInstance('0012_0000000054','0008_0000000008',1,10)
#writeHost('0014_0000000082',1,10)
#writeIp('0021_0000000006',1,10)
...
for i in range(networkSegmentCount):
    ...
    ipStart = ipCountPerNetworkSeg * i
...
for i in range(systemDesignCount): # 0 -> 10
    ...
    subSysDesignStart = subSystemDesignCountPerSystemDesign * i +1
    ...
    for j in range(subSystemDesignCountPerSystemDesign): # 0 -> 10
        ...
        subsysStart = subsysPerSubsysDesign * j * i + 1
        writeSubSystem(subsysDesign, subsysStart, subsysPerSubsysDesign)
        
        for k in range(subsysPerSubsysDesign): # 0-> 10
            unitStart = unitCountPerSubsys * k * j * i
            subsys = genGuid(subsys_prefix, subsysStartm ,k)
